...
public class FileOpenUtil {
    ...
    public static void openFile(Context context, File file,int barColor,int titleColor,String displayName){
        ...
        if(mimeType == null)
        {
            Toast toast = Toast.makeText(context,"程序未检测到可以打开此文件的应用",Toast.LENGTH_SHORT);
        ...
        {
            Intent intent = new Intent(context, TextReaderActivity.class);
        ...
        {
            Intent intent = new Intent(context, WebFileReaderActivity.class);
            intent.putExtra("barColor",barColor);
            intent.putExtra("titleColor",titleColor);
            intent.putExtra("filePath",file.getPath());
...
//        intent = Intent.createChooser(intent, "请选择对应的软件打开");
